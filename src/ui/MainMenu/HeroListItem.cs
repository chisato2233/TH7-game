...
namespace TH7.UI
{
    ...
    /// 英雄列表项 - 带点击动画
    /// </summary>
    public class HeroListItem : ScrollViewItem<HeroConfig>, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        public event Action<HeroConfig> OnClicked;
